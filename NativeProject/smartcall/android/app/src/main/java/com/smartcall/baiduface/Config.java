package com.smartcall.baiduface;
...
public class Config {
    ...
    public static String apiKey = "xm9GwV9tu5NXYXcnVa09PAKj";
    public static String secretKey = "YKkDfv9dgxNq13GR0drAjRdokSsGfuGn";
    public static String licenseID = "tad-face-collection-face-android";
